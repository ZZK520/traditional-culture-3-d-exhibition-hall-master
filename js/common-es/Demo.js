import * as CANNON from '/js/package/cannon-es.js'
 ...
 * @param {*} ballPosition 
 */
  rotateCamera = (ballPosition) => {
    // ballPosition.chassisBody.position;
    ...
    //1
    if (
      (ballPosition.chassisBody.position.x < 77 &&
        ballPosition.chassisBody.position.x > 42 &&
        ballPosition.chassisBody.position.z > -20 &&
        ballPosition.chassisBody.position.z < 40) ||
      (ballPosition.chassisBody.position.x < -2 && ballPosition.chassisBody.position.z < -28) ||
      (ballPosition.chassisBody.position.x < -25 &&
        ballPosition.chassisBody.position.x > -70 &&
        ballPosition.chassisBody.position.z > -10 &&
        ballPosition.chassisBody.position.z < 40)
    ) {
      targetPos = new THREE.Vector3(
        ballPosition.chassisBody.position.x,
        ballPosition.chassisBody.position.y + 50,
        ballPosition.chassisBody.position.z + 40
      );
    }
    ...
    //2
      ...
      ballPosition.chassisBody.position.x > -3 &&
      ballPosition.chassisBody.position.x < 22 &&
      ballPosition.chassisBody.position.z > 31 &&
      ballPosition.chassisBody.position.z < 58
    ) {
      targetPos = new THREE.Vector3(
        ballPosition.chassisBody.position.x,
        ballPosition.chassisBody.position.y + 50,
    ...
    //3
    else if (ballPosition.chassisBody.position.z > 50) {
      targetPos = new THREE.Vector3(
        ballPosition.chassisBody.position.x,
        ballPosition.chassisBody.position.y + 10,
        ballPosition.chassisBody.position.z + 40
      );
    }
    ...
    // revert back to original angle
      ...
      targetPos = new THREE.Vector3(
        ballPosition.chassisBody.position.x,
        ballPosition.chassisBody.position.y + 30,
        ballPosition.chassisBody.position.z + 60
      );
    }

    camPos.lerp(targetPos, 0.033);
    this.camera.position.copy(camPos);
    this.camera.lookAt(ballPosition.chassisBody.position);
  }
